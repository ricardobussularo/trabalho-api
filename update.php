...
<div class="container">
    <form id="addFormProduct">
        ...
        <div class="form-group">
            <button type="button" class="btn btn-primary" onclick="javascript:putProduct(<?=$_GET['id']?>);">Enviar</button>
        </div>
        <div class="alert-success" id="alertUpdate" style="display: none">Produto atualizado com sucesso</div>
    </form>
</div>
<script src="functions.js"></script>
<script !src="">
    getAllCategory();
    getOneProduct(<?=$_GET['id']?>);
</script>
</body>
</html>